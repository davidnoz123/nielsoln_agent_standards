...
def _build_content(sections, config, standards_sha, timestamp):
    ...
    lines += [
        ...
        f"<!-- Generated: {timestamp} | Standards SHA: {standards_sha} -->",
        "",
        "---",
        "",
        "## Source",
...
def main(argv=None):
    ...
    content = _build_content(sections, config, standards_sha, timestamp)
